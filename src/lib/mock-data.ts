...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    subAgents: [
      ...
      {
        name: "Safe Alternative Generator",
        status: "Completed",
        task: "4 alternatives",
        progress: 100,
      },
  ...
  },
  {
    ...
    progress: 0,
    logs: ["[11:58:00] Bot online: @merchiq_local_bot", "[12:00:22] Daily report sent to admin"],
    subAgents: [
...
export const recentLogs = [
  ...
  { t: "12:03:58", lvl: "warn", src: "fb_ads.pixel", msg: "Pixel A: only PageView event detected" },
  {
    t: "12:03:22",
    lvl: "info",
    src: "niche.opportunity",
    msg: "Score computed · 74/100 (dad life)",
  },
...
export const orders = [
  {
    ...
    platform: "Etsy",
    customer: "Ava Chen",
    product: "Retro Cat Dad Tee (L)",
    status: "Awaiting fulfillment",
    tracking: "—",
    action: "Send to Printify",
  },
  {
    id: "#SH-88210",
    platform: "Shopify",
    customer: "Marco Ruiz",
    product: "Summer Surf Hoodie (M)",
    status: "Shipped",
    tracking: "9400 1112 2334",
    action: "None",
  },
  {
    id: "#EO-19385",
  ...
  },
  {
    ...
    platform: "Etsy",
    customer: "Jamie W.",
    product: "Coffee First Mom Tee (S)",
    status: "Delivered",
    tracking: "9400 1112 2001",
  ...
  },
  {
    ...
    platform: "Shopify",
    customer: "Nora K.",
    product: "Golf Grandpa Tee (L)",
    status: "Shipped",
    tracking: "9400 1112 2402",
    action: "None",
  },
];
