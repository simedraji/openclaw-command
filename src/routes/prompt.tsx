  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        subtitle="Craft POD-ready image prompts for local diffusion models."
      />
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        <Panel title="Inputs">
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Field label="Style">
                <Input defaultValue="Retro 80s varsity" />
              </Field>
              <Field label="Target customer">
                <Input defaultValue="Millennial dad gift buyer" />
              </Field>
            </div>
            <div className="grid grid-cols-2 gap-2">
              <Field label="Shirt color">
                <Input defaultValue="Heather cream" />
              </Field>
            ...
            <Field label="Text phrase">
              <Input defaultValue="GIRL DAD ERA" />
            </Field>
            <Field label="Design elements">
              <Textarea
                rows={3}
                defaultValue="Sunset gradient, palm silhouettes, halftone, bold serif type, thick outlines"
              />
            </Field>
            <OpenClawTaskButton
              label="Generate POD prompt"
              message="Generate a POD-safe image prompt for a Girl Dad retro 80s varsity design. Include 4500x5400 px, 300 DPI, transparent background, centered DTG/DTF composition, and a trademark-risk reminder. Return only the final prompt and a short safety note."
            >
        ...
        >
          ...
          <div className="mt-2 text-[10px] text-muted-foreground">
            Example preview. OpenClaw-generated output appears in Mission Control → Recent run
            results.
          </div>
        </Panel>
      </div>
