      ...
      <PageHeader
        ...
        actions={
          <OpenClawTaskButton
            ...
            message="Create a concise POD competition-analysis report from the context and current configured research tools. Do not scrape restricted sources or contact competitors."
          >
            <Download className="h-3.5 w-3.5" /> Create report
          </OpenClawTaskButton>
        }
      />
      <Panel>
        <div className="flex flex-wrap items-end gap-3">
          <div className="min-w-[320px] flex-1">
            <Field label="Competitor URL">
              <Input defaultValue="https://etsy.com/shop/RetroDadCo" />
            </Field>
          </div>
          <OpenClawTaskButton
            label="Analyze competitor"
            message="Analyze the competitor at https://etsy.com/shop/RetroDadCo for POD positioning, listing quality, pricing, SEO gaps, and safe differentiation ideas. Respect website terms and do not automate prohibited access."
          >
            <Swords className="h-3.5 w-3.5" /> Analyze
          </OpenClawTaskButton>
        </div>
      </Panel>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
        <Panel title="Pricing comparison">
          {[
            ...
            <div
              key={n}
              className="flex justify-between border-b border-border/40 py-1.5 text-[12px] last:border-0"
            >
              <span>{n}</span>
